...
Three themes via `data-theme` on the root element: `:root` = gray mode (default, `#111111`), `[data-theme="dark"]` = dark mode (`#000000`), `[data-theme="light"]` = light mode (cream `#EDE4D7`). All themes redefine the same token names.
...
Other base variables: `--black/66/33/16/8`, `--gray/66/44/33`, `--blurpleColor/66/33`, `--blurpleLightColor/66`, `--goldColor/66`.
...
| Values (strings, numbers, bools) | `--foreground` |
| Punctuation (`:`, `"`, `,`) | `--white66` |
...
Glass color variants: `.btn-glass-blurple`, `.btn-glass-green`, `.btn-glass-rouge`, `.btn-glass-gold`
