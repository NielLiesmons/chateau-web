...
Chateau is a local-first, Nostr-native web application for discovering and
participating in Nostr communities (kind 10222), with content sections, profile-list
moderation, and the same architecture as Zapstore webapp.
...
**Phase 1: Communities** — Landing (Chateau hero + CTA), then Communities screen: list left, section pills + content right.
